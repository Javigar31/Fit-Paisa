...
## The Golden Rule
**Every animation MUST have a `prefers-reduced-motion` alternative.** This is non-negotiable for elite web design.
...
mm.add('(prefers-reduced-motion: no-preference)', () => {
  ...
  gsap.from('.hero-content', { opacity: 0, y: 50, duration: 1, stagger: 0.2 });
});
